...
- [ ] 頂部導覽出現「報表分析」主選單
- [ ] 子選單：銷售報表、利潤報表、傭金報表均可點選

### 銷售報表

- [ ] Pivot 視圖可顯示，預設依月份分組
- [ ] 可切換至 Graph（Bar）視圖
- [ ] 可更換 group_by（車款、車行、交易類型）
- [ ] 可更換 measure（amount_total、cost）

### 利潤報表

- [ ] Pivot 視圖可顯示 total_income、total_expense、net_profit
- [ ] Graph 視圖顯示 net_profit 逐月趨勢

### 傭金報表

- [ ] Pivot 視圖僅顯示 sale_type = dealer 的資料
- [ ] 可依車行 × 月份拆解傭金金額

...
戰情首頁看公司近十二月成交走勢、收款風險與待辦；營運總表逐筆查收支成本、核對及匯出；報表中心分析車型與通路。
...
- 月份數值表可查看精確數字及淨利可計入筆數，按核對明細進入相同日期條件的總表。只有有權限的人能開啟明細。
...
- 狀態色塊同時保留文字：灰＝草稿／取消、黃橙＝待配／待調、藍＝進行中、綠＝完成、紅橙＝退款或補件提醒。自家車行來源顯示「馭盛」。

/** @odoo-module **/
/**
 * dms_dealer_column_limit.js
 * 車行列表欄位顯示上限（15 欄硬限制）
 *
 * 說明：
 *  - Patch ListRenderer.prototype.toggleOptionalField
 *  - 僅對 dms.dealer 的 list view 生效
...
const DMS_DEALER_MODEL = "dms.dealer";
const MAX_VISIBLE_COLUMNS = 15;

patch(ListRenderer.prototype, "dms_core.dealerColumnLimit", {
    async toggleOptionalField(fieldName) {
        // 僅限 dms.dealer list view
        if (this.props?.list?.resModel !== DMS_DEALER_MODEL) {

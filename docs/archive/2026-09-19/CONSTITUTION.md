...
每次正式應用更新必須依 [SemVer 與發布流程](RELEASE_POLICY.md) 升版，新增首頁更新歷程，
保留已發布版本內容。相容修正升 PATCH、相容新增升 MINOR、不相容變更升 MAJOR。
完整 CI 通過後建立對應提交的附註標籤 vX.Y.Z；正式部署必須核對標籤，不以 commit 雜湊代替版號。

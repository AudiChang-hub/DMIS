...
class PriceListDistributionTests(TestCase):
    ...
    def test_assignment_page_explains_region_workflow_and_mobile_controls(self, _mock_localdate):
        ...
        self.assertContains(response, "price-assignment-order-cell")
        self.assertContains(response, "price-assignment-owner-control")
        self.assertContains(response, "data-drag-announcer")
        self.assertContains(response, "按住並拖曳")

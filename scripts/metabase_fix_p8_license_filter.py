...
P8_DASHBOARD_ID = 8
P8_DETAIL_CARD_ID = 54
P8_SUMMARY_CARD_ID = 105
...
def main() -> None:
    token = login()
    api(token, "get", f"/dashboard/{P8_DASHBOARD_ID}")

    card_ids = {P8_DETAIL_CARD_ID, P8_SUMMARY_CARD_ID}
    ...
    refreshed_dashboard = api(token, "get", f"/dashboard/{P8_DASHBOARD_ID}")
    dashcards_payload = []
    ...
    updated_dashboard = api(token, "put", f"/dashboard/{P8_DASHBOARD_ID}", payload)
